...
class _FeatureArticlePageState extends State<FeatureArticlePage> {
  ...
  Future<List<Discussionthread>> getFeaturedArticleData() async {
    ...
    //  var menuid = await getmenuid();
    Map jsonMap = {
      "methodname": "getfeaturearticlelatest", //"getfeaturedarticlenew",
      "locale": locale,
      "shortby": shortbyModifiedDate,
      "device_id": deviceID
    };
                  ...
                  SizedBox(
                    ...
                    child: IconButton(
                      ...
                      icon: const Icon(
                        ...
                        color: COLORS
                            .APP_THEME_DARK_RED_COLOR, //Color(0xff243444), //0xff243444
                      ),
  ...
  //             print('Refresh FeatureArticlePage');
  //             isLoading = true;
  //           });
  //         });
  //       },
                          ...
                          child: Padding(
                            ...
                            child: SizedBox(
                              ...
                              child: Text(
                                ...
                                style: const TextStyle(
                                    color: COLORS
                                        .APP_THEME_DARK_RED_COLOR, //Color(0xff000000), //Colors.black,
                                    fontFamily: 'HelveticaNueueBold',
                                    fontSize: 14,
                                    fontWeight: FontWeight.normal,
                                    height: 1.4,
