...
import 'home_screen_arabic.dart';
...
class Appenglish extends StatelessWidget {
  const Appenglish({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      ...
      fallbackLocale: LocalizationService.fallbackLocaleen,
